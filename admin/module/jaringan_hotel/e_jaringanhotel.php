...
if(val_number($_GET['id']))
{
    ...
    $edit = mysql_query("SELECT * FROM jaringan_hotel WHERE id_jaringan=".$id);
...
<div class="block">
	...
	<div class="block-content collapse in">
		<div class="span12">
			 <form class="form-horizontal" method="POST" action="<?php echo ADMIN_URL.'/module/jaringan_hotel/act_jaringanhotel.php?act=edit&module=jaringan_hotel';?>">
			  <fieldset>				
				<div class="control-group">
				  <label class="control-label" for="focusedInput">Jenis Hotel</label>
				  <div class="controls">
                    <input type="hidden" name="id" value="<?php echo $row['id_jaringan']; ?>"/>
					<input class="input-xlarge focused" id="focusedInput" type="text" name="nama_jaringan" value="<?php echo $row['nama_jaringan']; ?>"/>
				  </div>
				</div>
				<div class="control-group">
