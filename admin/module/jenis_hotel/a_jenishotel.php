...
<div class="block">
	...
	<div class="block-content collapse in">
		<div class="span12">
			 <form class="form-horizontal" method="POST" action="<?php echo ADMIN_URL.'/module/jenis_hotel/act_jenishotel.php?act=add&module=jenis_hotel';?>">
			  <fieldset>				
				<div class="control-group">
				  <label class="control-label" for="focusedInput">Jenis Hotel</label>
				  <div class="controls">
					<input class="input-xlarge focused" id="focusedInput" type="text" name="jenis_hotel"/>
				  </div>
				</div>
				<div class="control-group">
