...
<div class="block">
	...
	<div class="block-content collapse in">
		<div class="span12">
			 <form class="form-horizontal" method="POST" action="<?php echo ADMIN_URL.'/module/kategori_hotel/act_kategorihotel.php?act=add&module=kategori_hotel';?>">
			  <fieldset>				
				<div class="control-group">
				  <label class="control-label" for="focusedInput">Nama Kategori</label>
				  <div class="controls">
					<input class="input-xlarge focused" id="focusedInput" type="text" name="nama_kategori"/>
				  </div>
				</div>
				<div class="control-group">
